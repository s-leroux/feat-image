...
async function collect(pageurl) {
  ...
  const parser = new Parser({
    onopentag: function(name, attr) {
      ...
      if (name == "meta" && attr.property == "title" && attr.content) {
      ...
      if (name == "meta" && attr.property == "og:title" && attr.content) {
        result.title.add(attr.content);
      }

      if (name == "meta" && attr.property == "og:description" && attr.content) {
      ...
      if (name == "meta" && attr.property == "twitter:title" && attr.content) {
        result.title.add(attr.content);
      }

      if (name == "meta" && attr.property == "twitter:description" && attr.content) {
        result.description.add(attr.content);
      }
    },
  });
